...
/**
 * Externals matcher function for jQuery UI components.
 *
...
const jqueryUiMatcher = (request) => {
  ...
  return widget
    ? { library: `core/jquery.ui.${widget}`, external: 'undefined' }
    : false;
};

/**
 * Externals matcher function for Drupal libraries.
 *
 * @param {string} request The import path being requested.
...
module.exports.externalsMatcher = (request) => {
  switch (request) {
    ...
    case 'farbtastic':
    case 'joyride':
      return { library: `core/jquery.${request}`, external: 'undefined' };
    case 'jquery-ui':
    case 'jquery-ui/ui/widget':
      return { library: 'core/jquery.ui.widget', external: 'undefined' };
    case 'jquery-ui/ui/position':
      return { library: 'core/jquery.ui.position', external: 'undefined' };
    case 'modernizr':
